...
PLAN="$ROOT/scripts/injection_plan_dc_DI_only.csv"
PLAN_RESULT="$ROOT/scripts/injection_plan_dc_DI_only_result.csv"
OUTCOME="$ROOT/scripts/outcome_dc_DI_only.txt"
