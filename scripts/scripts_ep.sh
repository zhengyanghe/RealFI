...
PLAN="$ROOT/scripts/injection_plan_ep.csv"
PLAN_RESULT="$ROOT/scripts/injection_plan_ep_result.csv"
OUTCOME="$ROOT/scripts/outcome_ep.txt"
...
setarch $(uname -m) -R pin -t $PIN_TOOL -o $STAT -sample_interval $SAMPLE_INTERVAL -- $EXEC \
