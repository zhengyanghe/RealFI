...
PLAN="$ROOT/scripts/injection_plan_xsbench.csv"
PLAN_RESULT="$ROOT/scripts/injection_plan_xsbench_result.csv"
OUTCOME="$ROOT/scripts/outcome_xsbench.txt"
...
# =============================================
# Step 1~3: Profiler + FSS + Plan
# =============================================
echo "[Step 1] Running profiler → $STAT"
# 真跑的时候再打开
# setarch $(uname -m) -R pin -t $PIN_TOOL -o $STAT -sample_interval $SAMPLE_INTERVAL -- $EXEC $XSB_ARGS \
