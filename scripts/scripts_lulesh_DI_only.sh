...
PLAN="$ROOT/scripts/injection_plan_lulesh_DI_only.csv"
PLAN_RESULT="$ROOT/scripts/injection_plan_lulesh_DI_only_result.csv"
OUTCOME="$ROOT/scripts/outcome_lulesh_DI_only.txt"
