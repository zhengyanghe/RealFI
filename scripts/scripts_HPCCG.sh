...
PLAN="$ROOT/scripts/injection_plan_hpccg.csv"
PLAN_RESULT="$ROOT/scripts/injection_plan_hpccg_result.csv"
OUTCOME="$ROOT/scripts/outcome_hpccg.txt"
...
# =============================================
# Step 1: Run Profiler（每次都重新跑，确保最新）
# =============================================
echo "[Step 1] Running profiler → $STAT"
setarch $(uname -m) -R pin -t $PIN_TOOL -o $STAT -sample_interval $SAMPLE_INTERVAL -- $EXEC $HPCCG_ARGS \
