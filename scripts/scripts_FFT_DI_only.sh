...
PLAN="$ROOT/scripts/injection_plan_fft_DI_only.csv"          # <-- 改名
PLAN_RESULT="$ROOT/scripts/injection_plan_fft_DI_only_result.csv"
OUTCOME="$ROOT/scripts/outcome_fft_DI_only.txt"              # <-- 改名
