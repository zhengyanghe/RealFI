...
PLAN="$ROOT/scripts/injection_plan_mcf.csv"
PLAN_RESULT="$ROOT/scripts/injection_plan_mcf_result.csv"
SCRIPTS_DIR="$ROOT/scripts"
OUTCOME="$ROOT/scripts/outcome_mcf.txt"
...
CMD="setarch $(uname -m) -R pin -t $PIN_TOOL -o $STAT -sample_interval $SAMPLE_INTERVAL -- $MCF_DIR/mcf_base.amd64-m64-gcc42-nn $MCF_DIR/inp.in"
echo "Command: $CMD"
