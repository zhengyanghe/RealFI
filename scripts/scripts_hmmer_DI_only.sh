...
PLAN="$ROOT/scripts/injection_plan_hmmer_DI_only.csv"
PLAN_RESULT="$ROOT/scripts/injection_plan_hmmer_DI_only_result.csv"
OUTCOME="$ROOT/scripts/outcome_hmmer_DI_only.txt"
