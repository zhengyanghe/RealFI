...
PLAN="$ROOT/scripts/injection_plan_ocean.csv"
PLAN_RESULT="$ROOT/scripts/injection_plan_ocean_result.csv"

OUTCOME="$ROOT/scripts/outcome_ocean.txt"
...
python3 "$INCREMENTAL_STAT_PY" "$STAT" "$INCREMENTAL_STAT" || { echo "ERROR: Incremental calculation failed"; exit 1; }
