...
PLAN="$ROOT/scripts/injection_plan_lu_DI_only.csv"
PLAN_RESULT="$ROOT/scripts/injection_plan_lu_DI_only_result.csv"
OUTCOME="$ROOT/scripts/outcome_lu_DI_only.txt"
